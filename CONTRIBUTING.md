Contributing to Jadepay Core
============================

The Jadepay Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Jadepay Core project, and is not to be
confused with overall Jadepay Network Protocol consensus changes.

Whether a pull request is merged into Jadepay Core rests with the project merge
...
Patches that change Jadepay consensus rules are considerably more involved than
...
Where a patch set proposes to change the Jadepay consensus, it must have been
...
The project leader is the release manager for each Jadepay Core release.
