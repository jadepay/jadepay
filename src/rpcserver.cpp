...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Jadepay server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Jadepay features */
        {"Jadepay", "masternode", &masternode, true, true, false},
        {"Jadepay", "masternodelist", &masternodelist, true, true, false},
        {"Jadepay", "mnbudget", &mnbudget, true, true, false},
        {"Jadepay", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"Jadepay", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"Jadepay", "mnsync", &mnsync, true, true, false},
        {"Jadepay", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"Jadepay", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use Jadepayd, or the -server option to Jadepay-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> Jadepay-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22156/\n";
}
