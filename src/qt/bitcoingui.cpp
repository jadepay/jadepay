                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    GUIUtil::restoreWindowGeometry("nWindow", QSize(1020, 570), this);

    QString windowTitle = tr("Jadepay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Jadepay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Jadepay: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Jadepay Core"), this);
    aboutAction->setStatusTip(tr("Show information about Jadepay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Jadepay"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Jadepay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Jadepay addresses"));
    ...
    openAction->setStatusTip(tr("Open a Jadepay: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Jadepay Core help message to get a list with possible Jadepay command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Jadepay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Jadepay network", "", count));
}
...
{
    QString strTitle = tr("Jadepay Core"); // default title
