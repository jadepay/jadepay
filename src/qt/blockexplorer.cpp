...
{
    std::string genesisblockhash = "0x0000071d877e71cdd4072a6fca7e2fece5d6c902ba33671a83e658299a2c1b3c";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", false)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (Jadepay.conf).");
            QMessageBox::warning(this, "Jadepay Core Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
