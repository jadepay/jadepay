...
/** Utility functions used by the Jadepay Qt UI.
 */
namespace GUIUtil
{
...
// Render Jadepay addresses in monospace font
...
// Parse "Jadepay:" URI into recipient object, return true on successful parsing
