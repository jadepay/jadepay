...
void setupAddressWidget(QValidatedLineEdit* widget, QWidget* parent)
{
    ...
    widget->setPlaceholderText(QObject::tr("Enter a Jadepay address (e.g. %1)").arg("JWSbBnzmNkjDVaYHX7vkL1MqD96pRYWtZo"));
#endif
...
{
    // return if URI is not valid or is no Jadepay: URI
...
{
    // Convert Jadepay:// to Jadepay:
    //
    //    Cannot handle this later, because Jadepay:// will cause Qt to see the part after // as host,
...
void openConfigfile()
{
    ...
    /* Open Jadepay.conf with the associated application */
...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Jadepay.lnk";
}

bool GetStartOnSystemStartup()
{
    // check for Jadepay.lnk
...
{
    return GetAutostartDir() / "Jadepay.desktop";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    if (!fAutoStart)
        ...
        if (!optionFile.good())
            return false;
        // Write a Jadepay.desktop file to the autostart directory:
        optionFile << "[Desktop Entry]\n";
        optionFile << "Type=Application\n";
        optionFile << "Name=Jadepay\n";
...
LSSharedFileListItemRef findStartupItemInList(LSSharedFileListRef list, CFURLRef findUrl)
{
    // loop through the list of startup items and try to find the Jadepay app
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart && !foundItem) {
        // add Jadepay app to startup item list
