...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Jadepay Core Jadepay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  Jadepay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Jadepay transaction") + "\n" +
                               "  Jadepay-tx [options] -create [commands]   " + _("Create hex-encoded Jadepay transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Jadepay transaction
