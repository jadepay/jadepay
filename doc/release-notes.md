Jadepay Core version 2.2.1 is now available from:

  <https://github.com/Jadepay-project/Jadepay/releases>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/Jadepay-project/Jadepay/issues>

Compatibility
==============

Jadepay Core is extensively tested on multiple operating systems using
...
Jadepay Core should also work on most other Unix-like systems but is not
...
of Bitcoin that Jadepay was forked from.
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/Jadepay-project-translations/).
