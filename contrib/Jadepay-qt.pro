...
RESOURCES += src/qt/Jadepay.qrc src/qt/Jadepay_locale.qrc

TRANSLATIONS += src/qt/locale/Jadepay_bg.ts \
                src/qt/locale/Jadepay_de.ts \
                src/qt/locale/Jadepay_en.ts \
                src/qt/locale/Jadepay_es.ts \
                src/qt/locale/Jadepay_fi.ts \
                src/qt/locale/Jadepay_fr.ts \
                src/qt/locale/Jadepay_it.ts \
                src/qt/locale/Jadepay_ja.ts \
                src/qt/locale/Jadepay_pl.ts \
                src/qt/locale/Jadepay_pt.ts \
                src/qt/locale/Jadepay_ru.ts \
                src/qt/locale/Jadepay_sk.ts \
                src/qt/locale/Jadepay_sv.ts \
                src/qt/locale/Jadepay_vi.ts \
                src/qt/locale/Jadepay_zh_CN.ts \
                src/qt/locale/Jadepay_zh_TW.ts
